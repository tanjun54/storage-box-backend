package com.neusoft.project.common.service;

import com.alibaba.fastjson.JSONObject;
import com.neusoft.common.constant.Constants;
import com.neusoft.common.constant.HttpStatus;
import com.neusoft.common.exception.CustomException;
import com.neusoft.common.exception.user.UserPasswordNotMatchException;
import com.neusoft.common.utils.MessageUtils;
import com.neusoft.common.utils.StringUtils;
import com.neusoft.framework.manager.AsyncManager;
import com.neusoft.framework.manager.factory.AsyncFactory;
...
public class CommonService {
    ...
    public AjaxResult sentPostLogout(String url, HttpServletRequest request) {
        ...
        try {
            ...
            // 返回退出登录失败
            return AjaxResult.error("退出登录失败" + e.getMessage());
        ...
        // 返回退出登录结果
        return getAjaxResult(url, result);
    }

    /**
     * 返回退出登录结果
     *
     * @param url    替换后的上下文url
     * @param result 请求结果
     * @return 退出登录结果
     */
    private AjaxResult getAjaxResult(String url, StringBuilder result) {
        // 判断返回结果是否为空
